...
Campaign Structure
Google Ads allow you to create multilevel campaign structures. You have Campaigns, Ad Groups and Ads. Facebook also has a multilevel campaign structure with Campaigns, Ad Sets and Ads. LinkedIn uses a single level campaign structure where you create Campaigns and Ads under each campaign. This makes it more difficult to segment your campaigns so you have to be creative with your campaign naming convention.
For example, I have a Facebook ad campaign named LinkedIn Book Free Chapter where I offer a free chapter of my LinkedIn book. Under that campaign I have many Ad Sets so I can track which audiences are performing best. Some of my Ad Set names are US Male 45-60 Biz Owner targeting US-based male business owners between 45 and 60 years old or UK Female Coaches 30-40.
Under each Ad Set I use a similar naming convention for the ads. I would use "Leverage These 7 Tips - sponsored post - ent mag - book image - warm traffic" as the ad name. I use the headline of the ad, the ad type, target audience, the image name and the Traffic Temperature as my ad title. This lets me quickly see which ads are performing best.
In LinkedIn, we can use creative campaign and ad names to achieve the same result. LinkedIn campaign names have a 50 character limit so we have some room to play with. Create a naming convention for your campaigns so you have consistency. Here are some examples to help you create your naming convention.
Name of event/webinar/Tripwire offer you are promoting
...
Company size
Here’s an example:
LI profile tips - Sales - VP - Fortune 100 - cold traffic
In this example I would be offering a LinkedIn profile tips cheatsheet to Vice Presidents in sales who work for Fortune 100 companies. The traffic temperature is cold.
