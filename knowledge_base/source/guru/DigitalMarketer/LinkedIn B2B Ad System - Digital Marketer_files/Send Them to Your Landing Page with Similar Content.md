# Send Them to Your Landing Page with Similar Content.html
...
Send Them to Your Landing Page with Similar Content
When I click on this LinkedIn ad, LinkedIn continues the conversation on the landing page with the video and great content. They use the same image on the content page and don’t require an optin to view the content. At the bottom of the page they have multiple options to subscribe to the LinkedIn blog for more content.
To learn more about creating relevant content, visit the Content Engine Execution Plan.
