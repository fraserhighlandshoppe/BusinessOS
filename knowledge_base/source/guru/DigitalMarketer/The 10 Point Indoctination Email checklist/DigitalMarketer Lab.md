...
Overview
This Execution Plan is intended as a checklist for anyone writing or refreshing their initial communication with brand-new subscribers to their email list. It is not intended to be a course on copywriting but will provide the key elements that should be included in your indoctrination of new subscribers.
