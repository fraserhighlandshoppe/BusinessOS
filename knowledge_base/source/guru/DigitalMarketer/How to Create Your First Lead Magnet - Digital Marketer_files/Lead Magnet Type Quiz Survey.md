# Lead Magnet Type Quiz Survey.html
...
The quiz asks a series of questions and then drops you on this results page. If you want to save your results are prompted to create an account and enter in your email.
