# Does it Speak To a Known Desired End Result.html
...
Lending Tree knows that its user are looking for loans and one of the things that effects that is the customer’s Credit score. Here they segment this audience even further with a tabbed menu system with each delivering on a specific end results that prospect might be looking for.
In this example one of the first things you might want to check before applying for a loan is to check your credit score.
When you click to get your free score you land on the page below to fill in your information.
