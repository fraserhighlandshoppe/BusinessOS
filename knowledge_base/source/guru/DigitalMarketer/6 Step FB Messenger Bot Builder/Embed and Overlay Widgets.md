# Embed and Overlay Widgets.html
...
Embeddable Widget & Overlay Widget
These growth tools allow you to send traffic from your website to Facebook Messenger. They’re a great way to redirect your website traffic onto Messenger, so that you can add visitors to your subscriber list and keep in touch with them going forward.
A lot of people use the embeddable and overlay widgets to offer something for free—like a free report, white paper, or other Lead Magnet—that you deliver to your visitors through Messenger. (Similar to how many email opt-in landing pages work.)
Another option is to use these widgets to ask your visitors if they have any questions about a product or service—so you can quickly answer their questions in real-time. (This can be especially helpful on sales pages where it’s important to overcome your prospects’ objections while they’re still deciding whether or not to purchase from you.)
Here’s an example of how Jason Swenk uses this widget on one of his sales pages:
In ManyChat, you can find these widgets under Growth Tools:
As you can see, you have 6 different options. You can add a bar to the top of your website, a modal popup, a slide-in window, etc.
And when you click on 1 of the tools, the right-hand side of the screen will show you what the widget will look like:
Of course, you can customize details like the colors, the text, when the bar will appear, and so on.
You can also customize the “Submitted State,” which is what will show after the person clicks on your button:
And similar to the Ref URL growth tool, you next have to specify which opt-in message to send the user and which sequence to subscribe them to:
When you’re done with that and the growth tool is set up just how you want it, the last step is to install ManyChat’s JavaScript snippet to your website so that it can display the tool to your visitors:
