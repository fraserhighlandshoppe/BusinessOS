# XREF — saved_resource(2)_xref
# Source: saved_resource(2).md
...
|---|---|---|
| 1 | Line ~1 — # saved_resource(2).html | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
