# XREF — saved_resource(1)_xref
# Source: saved_resource(1).md
...
|---|---|---|
| 1 | Line ~1 — # saved_resource(1).html | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
