# XREF — MastertheColdCall_xref
# Source: MastertheColdCall.md.md
...
|---|---|---|
| 1 | Source file: MastertheColdCall.md.md (line review needed) | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
