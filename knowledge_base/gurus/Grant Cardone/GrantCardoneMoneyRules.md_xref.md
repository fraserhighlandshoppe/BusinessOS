# XREF — GrantCardoneMoneyRules_xref
# Source: GrantCardoneMoneyRules.md.md
...
|---|---|---|
| 1 | Source file: GrantCardoneMoneyRules.md.md (line review needed) | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
