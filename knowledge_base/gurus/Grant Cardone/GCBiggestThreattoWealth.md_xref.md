# XREF — GCBiggestThreattoWealth_xref
# Source: GCBiggestThreattoWealth.md.md
...
|---|---|---|
| 1 | Source file: GCBiggestThreattoWealth.md.md (line review needed) | HRHowTo.md (relevant section) |
| 2 | Context: framework/header reference to domain source | HRHowTo.md (relevant section) |
