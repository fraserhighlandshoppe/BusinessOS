# XREF — GrantCardoneSalesTipes_xref
# Source: GrantCardoneSalesTipes.md.md
...
|---|---|---|
| 1 | Source file: GrantCardoneSalesTipes.md.md (line review needed) | SalesHowTo.md (Section 4 - Closing/Negotiation) |
