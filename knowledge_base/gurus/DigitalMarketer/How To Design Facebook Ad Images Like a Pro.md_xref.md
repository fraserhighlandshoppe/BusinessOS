# XREF — How To Design Facebook Ad Images Like a Pro.md
# Source guru/file: How To Design Facebook Ad Images Like a Pro.md_xref.md
# Format: table (para by para ordered)
| Para | Source .md file line/context | Destination (HowTo/domain) | Notes |
|---|---|---|---|
| 1 | Line ~1 — # How To Design Facebook Ad Images Like a Pro.html | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
| 4 | Line ~4 — How To Design Facebook Ad Images Like a Pro | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
