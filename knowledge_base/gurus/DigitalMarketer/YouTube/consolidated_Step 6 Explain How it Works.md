# Content from Step 6 Explain How it Works.md

## Topic: YouTube

# Step 6 Explain How it Works.html
...
Step 6: Explain How it Works
This is usually the longest step of a VSL. Here, you'll explain how your solution (the product or service you're selling) creates the transformation/results you talked about in Step 4.
...
NOTE: Try to visualize the finished video as you write the script. What will it look like? Will there be music? Do you want words to appear when you say specific words? Do you want to switch from a head-on to a screen-capture?
