# Content from Running Ads to These Audiences.md

## Topic: YouTube

# Running Ads to These Audiences.html
...
Let’s use the blogging audience as an example.
As soon as we’re able to populate a retargeting audience, we will start running ads just like the one below:
Again, since we know that this audience is interested in blogging, the 60 second blog plan lead magnet made the most sense.
If you don’t have enough traffic to segment your audiences, simply run an ad to everyone that has visited your website.
