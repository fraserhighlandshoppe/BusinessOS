# Content from Installing the Code.md

## Topic: YouTube

# Installing the Code.html
...
In business manager, click the “pixels” button:
Then, click “actions” and “view pixel code”:
Click on advanced matching (turn it on), and then copy the pixel code:
Copy the code below and paste the code  between the
and
in your website code. The pixel will track visits to every page of your website.
Don’t let this technical barrier get in your way.
The install will vary depending on what your site is built on.
If you can’t figure out how to install the pixel, hire someone on Fiverr or leverage Youtube/Google to search for the process for the system that your site is built on.
For example, search YouTube for “Install Facebook Pixel on Wordpress”.
Facebook also walks you step by step here: https://www.facebook.com/business/help/952192354843755?helpref=faq_content
