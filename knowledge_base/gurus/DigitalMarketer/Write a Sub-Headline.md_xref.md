# XREF — Write a Sub-Headline.md
# Source guru/file: Write a Sub-Headline.md_xref.md
# Format: table (para by para ordered)
| Para | Source .md file line/context | Destination (HowTo/domain) | Notes |
|---|---|---|---|
| 1 | Line ~1 — # Write a Sub-Headline.html | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
