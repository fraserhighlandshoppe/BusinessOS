...
Analyzing Your Results
Of course you want to monitor your LinkedIn campaigns on a regular basis to maintain an optimal CTR, a low CPC and a high conversion rate. The key to running successful online marketing campaigns is to constantly test different ads, landing pages, and tripwires. You have to constantly test, monitor and test some more to get the most from your advertising dollar.
The How to Master Google Analytics Execution Plan is a great resource to learn how to analyze your marketing campaign data.
