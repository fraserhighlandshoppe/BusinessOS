# 9 Places to Place an Opt-In.html
...
To get more opt-ins, you need to add as many opportunities to opt-in as possible.
...
1. Sidebar Opt-ins -  Subscription widgets in your sidebar are a very simple way to boost opt-ins, and almost every site you visit has one. MailChimp has a simple plug-in that will integrate your MailChimp opt-in box into your sidebar. Be sure that you feature your Lead Magnet in your sidebar opt-in.
2.  In-post Opt-In - We don’t usually embed an opt in form directly in a post. We use an image of the lead magnet with a CTA that links over to our landing page.
3. Hello Bar - A company called Hello Bar offers a top-down subscription form, which hangs out at the top of your page as a subtle reminder to opt-in. SumoMe also has a great free tool as well.
When a visitor clicks the bar, the opt-in box drops down, offering them a chance to input their email. Hello Bars have become extremely popular because of how unobtrusive they are to readers. SumoMe also offers the option to opt in directly in the bar along with providing copy and a CTA.
4.  Pop-up Opt-in -  You can use a program like Optimonk and Optin monster to create great pop-up opt-ins that feature your Lead Magnet. Optin monster has more customization and Optimonk has designers to help make things your own. Both have advanced target and trigger systems to customize who does (and more importantly who doesn't) see your pop.
