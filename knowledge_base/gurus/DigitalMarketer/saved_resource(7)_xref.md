# XREF — saved_resource(7)_xref
# Source: saved_resource(7).md
...
|---|---|---|
| 1 | Line ~1 — # saved_resource(7).html | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
