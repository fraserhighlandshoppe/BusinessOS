# 3DM Engage Cold Prospects.html
...
2. Get Clear on the Value You Deliver
Understand The Before and After Grid
Before and After in Action
Complete Your Before and After Canvas
3. Create Your Customer Value Journey
...
When we’re creating a new campaign here at DigitalMarketer, we always start by looking at the Value Journey map and identifying any steps where we need help. And in this case, we realized that while we were doing a good job of generating awareness through Facebook ads, we didn’t have a good engagement campaign in place.
So, what we did was create some content (a branding video) whose goal was to get people engaged with DigitalMarketer:
But as you know, just creating a video isn’t enough. We also had to decide how we were going to get people to actually watch the video. So we chose to run a Facebook ad campaign (with video views as the goal) to generate traffic to the video. This made up the “Traffic” portion of our campaign.
Here’s what one of those ads looked like:
And because the goal of this campaign is to get people engaged with us, our call-to-action was very simple: “Watch this video!”
