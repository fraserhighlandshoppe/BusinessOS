# Content from Set Up WCA for Your Content.md

## Topic: Lead

# Set Up WCA for Your Content.html
...
Log in to Facebook Business Manager and click the “audiences” tab, as soon below:
...
Remember, we’re wanting to include the URLS (the part of the URL past the root domain… www.digitalmarketer.com/6-million = /6-million) of any article that we have on the website that doesn’t have “blogging” in the URL BUT, that we want to include in this audience.
...
Website Traffic: When setting up categories to segment you audience, check “Custom Comination“. We’ll get into the other options later in the EP.
Include (URL CONTAINS): As you can see, I added all of the URLs (the text after the .com – the root domain) of old content from our excel sheet in the category of blogging. I also added the keyword “blogging” (highlighted in blue) to ensure every page we create from here on out that has to do with blogging will be added to this WCA — as long as we include the word ‘blogging’ in the URL. Dynamic, baby!! I’ll never have to come back and edit this audience again.
Number of Visits: Keep this at 1 to start.
In the last: The default is 30 days. Facebook will let you go up to 180 days. I usually maximize the length at 180 days so that we can keep people in our audience for as long as possible.
...
This way, I’m segmenting our FB custom audiences into specific topics. If you don’t have a way to segment an audience go ahead and set up a WCA for everyone who hits your site at all – why not?
Follow the steps above but simple select “Anyone Who Visits Your Website” instead of “Custom Combination”.
