# Content from Using TowerData to Profile Your Buyer's List.md

## Topic: Lead

# Using TowerData to Profile Your Buyer's List.html
...
That will tell you who they are and then you can easily target them using Facebook, AdWords, Twitter and Pinterest audience targeting tools.
If you don’t have a buyers list to start with, you can still find out a lot about your target audience using several different free tools, including QuantCast, Alexa and SimilarWeb.
The next step will show you how to do it.
