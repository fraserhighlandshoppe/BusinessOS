# Content from Setting Up Custom Conversions.md

## Topic: Lead

# Setting Up Custom Conversions.html
...
Setting up a custom conversion works very similarly to a custom audience setup: You can define a specific type of conversion based on URLs visited, events performed, events with certain parameters, etc.
