# XREF — consolidated_index(1)_xref
# Source: consolidated_index(1).md.md
...
|---|---|---|
| 1 | Source file: consolidated_index(1).md.md (line review needed) | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
