# XREF — saved_resource(3)_xref
# Source: saved_resource(3).md
...
|---|---|---|
| 1 | Line ~1 — # saved_resource(3).html | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
