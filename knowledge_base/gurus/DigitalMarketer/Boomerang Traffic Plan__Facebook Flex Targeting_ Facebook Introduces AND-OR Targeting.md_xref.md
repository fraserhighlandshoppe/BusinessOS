# XREF — Boomerang Traffic Plan__Facebook Flex Targeting_ Facebook Introduces AND-OR Targeting.md
# Source guru/file: Boomerang Traffic Plan__Facebook Flex Targeting_ Facebook Introduces AND-OR Targeting.md_xref.md
# Format: table (para by para ordered)
| Para | Source .md file line/context | Destination (HowTo/domain) | Notes |
|---|---|---|---|
| 1 | Line ~1 — # Facebook Flex Targeting_ Facebook Introduces AND-OR Targeting.html | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
| 4 | Line ~4 — Facebook Flex Targeting: Facebook Introduces AND-OR Targeting | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
