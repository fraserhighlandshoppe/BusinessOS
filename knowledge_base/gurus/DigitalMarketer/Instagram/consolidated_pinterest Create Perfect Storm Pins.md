# Content from pinterest Create Perfect Storm Pins.md

## Topic: Instagram

# pinterest Create Perfect Storm Pins.html
...
The image - You have tested different colors, lengths, borders, layouts, etc and found a winning image.
The keyword - You have tested different pin descriptions.
When you find the "Perfect Storm" Pin --- it will send you an avalanche of traffic.
Getting traffic from Pinterest is about testing and finding the best pins and posting them more often.
Most pins won't perform well but stick with it and keep optimizing --- eventually you will hit a home run.
