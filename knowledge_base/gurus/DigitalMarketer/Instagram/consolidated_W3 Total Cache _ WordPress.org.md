# Content from W3 Total Cache _ WordPress.org.md

## Topic: Instagram

# W3 Total Cache _ WordPress.org.html
...
Great Plugin
other1
Really lets you speed things up.
Exceptional Plugin – Immediate Performance Improvement
We have just installed and with basic settings to notice impressive difference in loading pages and posts, including popups and videos.
An excellent Experience
lopezcosenza
Learning curve really short, the plugin does what it says in its description. Ideal to handle the cache of several sites because it allows to export and import the configuration.
Congratulations and success to the developers.
AMLC / SMDDL
Thanks!!!
denisinfrabh
Thanks!!!
The best!!
Great plugin
Read all 4,019 reviews
Contributors & Developers
“W3 Total Cache” is open source software. The following people have contributed to this plugin.Contributors
Frederick Townes
“W3 Total Cache” has been translated into 6 locales. Thank you to the translators for their contributions.Translate “W3 Total Cache” into your language.Interested in development?Browse the code, check out the SVN repository, or subscribe to the development log by RSS.
Changelog
0.9.7.1
...
See all 7
Close
Croatian, English (Canada), English (UK), English (US), French (France), Occitan, and Spanish (Spain).
Translate into your language
Tags: cachecachingcompressionmaxcdnseo
Advanced View
Ratings See all
5 stars
2,816
...
Code is Poetry.
Skip to toolbar
About WordPressAbout WordPressWordPress.orgDocumentationSupport ForumsFeedbackSearchLog InRegister
```
