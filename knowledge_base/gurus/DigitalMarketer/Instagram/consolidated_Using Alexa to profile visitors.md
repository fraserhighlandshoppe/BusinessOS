# Content from Using Alexa to profile visitors.md

## Topic: Instagram

# Using Alexa to profile visitors.html
...
Using Alexa to Profile Visitors
Let’s take a look at Alexa and see what they have for our Memory-Improvement-Tips.com site. The images below shows what Alexa has to say about this site:
Interesting but terribly useful initial data on where the site ranks globally and in the US.
Most visitors are from the USA, but there’s a respectable presence from India and the UK, so when you get to audience targeting for ads, these may be markets to consider checking out.
Note that the “Top Keywords From Search Engines” section again re-confirms the broad interest in gaming sites for this audience with 2 scrabble sites, Uno and the gaming site, Cubefield comprising 4 out of 5 of the top keywords.
Alexa tells us that a related site is Lumosity.com which is a brain training site. Again, a game-like site.
And, finally, some demographic information from Alexa:
