# XREF — podcast-distribution-schedule_xref
# Source: podcast-distribution-schedule.md
...
|---|---|---|
| 1 | Line ~1 — # podcast-distribution-schedule.pdf | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
