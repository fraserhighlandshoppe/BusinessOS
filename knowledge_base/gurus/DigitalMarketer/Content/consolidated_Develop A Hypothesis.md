# Content from Develop A Hypothesis.md

## Topic: Content

# Develop A Hypothesis.html
...
Develop A Hypothesis
A test without a hypothesis is just a guess.
You don’t want to test a new variation because ‘You think it will work’ or because ‘someone else is doing it’. You want to optimize the user experience, and the only way to do that is by looking at the data.
You need both qualitative and quantitative insights to create a solid hypothesis. Look at raw conversions, the conversion rate, and bounce rate. These numbers will let you know if there is a problem with your current landing page.
Now the fun part, looking at the qualitative data. Make sure to put your landing page in context. Is there a sense of continuity from the initial ad click and the landing page? Do they have similar images, color scheme, and the identical offer? If all of these things are in order there are other tools you can use to grab better qualitative insights.
First, I’d recommend using a click tracking tool like Crazy Egg or Hotjar.
If you have a page and the CTA isn’t getting clicks, you know what you need to fix!
These tools will understand the flow of your layout as well as the most important content.
For those with longer form landing pages, scroll tracking will give you some great insights as well. For example, if you have a single CTA at the bottom of your long form sales letter but only 10% of people scroll to the bottom, you now have an opportunity!
Other sources of qualitative data include...
surveys,
personas,
user testing,
customer service inquiries,
and sales inquiries.
You have more qualitative data than you know, and this is absolutely crucial for hypothesis construction.
If you have enough qualitative and quantitative data to develop a hypothesis, you’re going to want to put it in this format:
We believe that changing A for visitors B will cause C to happen.
Never run a test that can’t be put in this format.
