# Content from Youtube Add YouTube.md

## Topic: Content

# Youtube Add YouTube.html
...
Community
Getting Started
Social Selling: How to Generate Leads and Sales from Social Media
Previous Step
Next Step
1. Start Here
Note From the Author
How to Get the Most Out Of Your Execution Plan
Understand the Social Success Cycle
Understand The Value First Strategy
Choose Your Social Media Channel
How to Use the Social Selling Execution Plan
2. Use Pinterest
Why Use Pinterest?
...
Ok --- this is big...
As YouTube marketers we've been waiting for this FOREVER. If you aren't marketing on YouTube... it's time for you to take another look. And...  if you're already on YouTube you need to know about this. But first, let me explain the problem.
YouTube Marketing... the old school way
Ok, it's not old school yet.
In fact, most people don't know about this new feature I'm going to share with you today.
Here's the thing...
50% of video views on the YouTube platform are mobile. This is a BIG problem for those of us generating leads and sales from YouTube. Here's why... The old way to get clicks from YouTube was to add something called an ANNOTATION to your video.  An Annotation is just a call-to-action box that lays over the top of the video.
These annotations work REALLY well to generate leads and sales.  In fact, we've generate over 140,000 leads from the Annotation call-to-action. But there's one MASSIVE problem with Annotations... They don't work on mobile.
YouTube Marketing... the new school way
Enter YouTube Cards.
YouTube Cards are a HUGE development because for the first time you’ll be able to send traffic from mobile YouTube videos to your website. This means that by simply installing the YouTube Cards to your videos, you can essentially DOUBLE your traffic, leads, and sales from YouTube.
This new feature will have a MASSIVE effect on our channel ILoveBasketballTv, as 48% of the views are from mobile (found in your YouTube analytics dashboard) it could essentially double our business.
What do they look like?
Here’s a video of Get More Views founder Adam Linkenauger with the new card applied:
(Yesterday I wrote about this new feature on my Get More Views blog, and today I wanted to share it with you.)
And I noticed that the Digital Marketer team has already started changing their videos over to YouTube Cards...
...
5.) Associated website card: link directly to your associated website from a card. This is by far the most important one for an online business and I am going to show you how to set them up for your channel. We use the exact same process we taught in this article about getting free leads from YouTube... except now this works on mobile.
...
Upload an image (or pick one from the suggestions offered). Edit and optimize the title and call-to-action text and click save.
...
(After they see the “i” when hovering over the video.)
(Once they click the YouTube Card, Your Call to action text and image pop up below.)
(We recommend you send viewers to a Lead Magnet squeeze page like we teach in this article that is congruent with the Card so that you can collect their email address.)
Now you’re ready to start generating traffic to from MOBILE to your website or landing page.
This is one of the biggest YouTube feature releases to date. WHY? It directly effects traffic, leads, and sales for your business. If you already have a channel implement these cards TODAY.
...
$295/month
Try Lab Elite FREE for 10 Days
$2995/year
Try Lab Elite FREE for 10 Days
Lab ELITE TEAM
