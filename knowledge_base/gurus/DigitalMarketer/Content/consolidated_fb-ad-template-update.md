# Content from fb-ad-template-update.md

## Topic: Content

# fb-ad-template-update.pdf
...
We’ve created 567 Facebook ad campaigns in the past year… and
...
But, I’ve realized that we talk a lot about the targeting, bidding,
...
This ad is speaking to people who blog. With the copy, we wanted to
...
This ad is for our Social Media Headline Swipe file.
...
This ad is speaking to people who are social media managers or are
...
This ad generated leads for a launch of our product called The
...
Tying in a theme that would relate to your target audience is a great
way to relate.
...
This ad ran to people who were interested in email marketers, mostly
...
Facebook Social List Building
The step-by-step guide to creating a high converting Facebook
Ad Campaigns that generate leads and sales for your business
...
This ad is part of a bigger campaign for our Gain, Logic, Fear email
template campaign.
...
The Copy: This campaign had multiple ad sets that targeted different
...
The “Copy & paste this FREE email series into your account today.”
made people think:
...
If you’re ever selling something that is timely, that won’t always be
...
Once we were about to close registration for the class, we ran this ad
for 72 hours.
...
to introduce them to The Machine (the football field ad for example).
Also, the ad was eye-catching (of course) and would have stopped
...
Look familiar? This is a retargeting ad for the funnel I introduced in
ad #1 above.
...
Why does it work?
The Image: You’ll notice that the ads are VERY SIMILAR. You want to
catch their attention by showing them something that they’re familiar
with, but create a bit of variation so they don’t think it’s the same ad.

30
31

You’ll also notice that second ad says “1,000 Blog Subscribers” –this is because the tripwire teaches you how to get your first 1,000
blog subscribers.
The Copy: The most important thing to keep in mind is the copy. We
use “Did life get in the way? You forgot to take advantage of this
deal?”.
...
people who opted in for the social swipe file (ad #2 in this blog post)
but didn’t purchase the tripwire from that funnel:

32
33

To learn more about how we dynamically retarget throughout our
funnels using Facebook Website Custom Audiences, click here.
34
33
...
This is a Facebook offer. Facebook offers are a certain kind of ad for
discounts, flash sales, etc. They appear differently in the news feed
...
thanks them for claiming the offer, and then they’re given the link to
claim the offer and it’s ALSO emailed to them!
...
Why does it work?
Facebook offers are shared a ton and receive awesome organic reach
because people want to share deals with their friends. Also, the
email touch point is BIG.
The Image: This image shows a highly engaged conference. It
catches people’s attention and shows them that Traffic & Conversion
Summit isn’t a borefest.
...
When used appropriately, offers are powerful Facebook
advertisements.
