# Content from Step 4 Present the Solution.md

## Topic: Content

# Step 4 Present the Solution.html
...
DO mention the product by name. It's good to mention the name more than once, so it becomes familiar and memorable, as we do in a VSL script for our Marketer-In-Residence program, a summer internship program we offered at DigitalMarketer.
DON'T talk about how the product works. (You'll do that in Step 6.) Keep the focus on what it does and the transformation or results it delivers.
