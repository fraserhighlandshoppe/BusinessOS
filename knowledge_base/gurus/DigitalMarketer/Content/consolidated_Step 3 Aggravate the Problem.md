# Content from Step 3 Aggravate the Problem.md

## Topic: Content

# Step 3 Aggravate the Problem.html
...
For longer videos, use statistics, stories, demonstrations, facts, etc., to show just how important the problem really is.
