...
As legendary direct response marketer Robert Collier would advise:
...
More importantly, this is your FIRST transaction with this prospect. Make it a good great one!
...
It should have tremendous stand alone value but that doesn't mean it needs to be elaborate, complex or at all lengthy. In fact, when you understand the whole of the Customer Value Optimization process you'll know why an elaborate, complex or lengthy Lead Magnet will dampen your profits.
Example:
...
Action Step:
Write the promise you will deliver upon in your Lead Magnet Worksheet & Checklist.
