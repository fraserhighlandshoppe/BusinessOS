# Content from Pinterest pptimize board cover.md

## Topic: Social

# Pinterest pptimize board cover.html
...
To clarify, a Pinterest user can choose to search Pinterest by individual pins or boards.
So, for example if I type in 'survival' in Pinterest I will see (by default) all individual pins...
But, by selecting "Boards" i can view collections of individaul pins (called Boards)...
In this step, you will create "Board Covers" that have a text overlay that labels them with the Pinterest keyword you are trying to optimize the board for.
Here's how the Board Covers look on the Sruvival Life page...
And at DIY Ready...
Learn how to change the Board Cover image here.
Notice how this Board Cover stands out in Board search on Pinterest...
