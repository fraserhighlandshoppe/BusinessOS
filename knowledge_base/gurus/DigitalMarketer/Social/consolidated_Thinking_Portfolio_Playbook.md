# Content from Thinking_Portfolio_Playbook.md

## Topic: Social

# Thinking_Portfolio_Playbook.pdf
...
important attribute is the individual’s ability to understand the project. This allows the PMO to initiate,
monitor and manage better, and see if it rings true
with the company’s core goals and objectives. Here is
...
general workflow in the department. While they won’t
...
executives who haven’t had an experience as a project manager have taken on the role, it has not always
...
hiccups. The PMO’s role is to work in close quarters
...
acts as a partner who is a helpful resource, instead of
...
management’s lack of understanding of the benefits
...
for project managers to manage their project portfolios efficiently.
...
Today’s ever-changing business environment often presents numerous challenges, while positive
...
what their secret to success is. Share the secret
...
peer’s skills and valuable insight – you might
...
3. How you can prioritize budgets with
business metrics?
...
producers then you’ll have the luxury of one of the
...
els and parameters may need to be updated as the
...
A business decides to implement PPM based on an
...
things. This means that projects need to be delivered
...
investments in innovative business practices, businesses don’t seem to get satisfactory returns. This is
...
You must develop services that save the client’s
...
best of your company’s PPM and provide quick, profitable and tangible results.
...
sharing.
3. Don’t wait for a problem to crop up before
you review PPM processes. Ensure that you
establish certain process owners and encourage

© Thinking Portfolio

them to find better and more streamlined ways
...
lot more than simple profit or loss statements. This
...
on investment (ROI).
Whether it’s for increased customer satisfaction,
...
management – For effective portfolio management, the process itself should be deeply rooted
...
and thereby enabling the company to be successful.
If the tools are not conducive to the organization’s
...
to use and easy to understand; today’s tools are expected to be intuitive, not requiring advanced training. The best tools today are more like services that
...
well defined and narrow. Conceptual questions don’t
...
latch to. An analogy, for example, could do the trick:
...
keen on building upon other people’s ideas on web
...
The experience of UBS Investment Bank’s Idea
...
lows the attendees to post their ideas on a simple,
...
6 Things that a Successful PMO Won’t do
...
a team’s ability to function efficiently. Add to that inflexibility and you’re guaranteed to fail. Good PMOs
...
Unless a PMO is aligned to the agency’s overall
...
constraints and limited resources. A good project
...
PMO leader’s role will be to get lines of communication going so collaborative projects can work. He
...
In today’s challenging business environment project management is a combination of hard decisions
...
cording to a recent white paper published by Dr.
Brian Hobbs of University of Quebec, PMO is an
integral part of an organization’s project management structure and are linked to multiple activities at a single point of time. These PMO have low
...
office has to implement regulations within a corporate’s work culture to reduce inefficiency and
...
5. Evolving role in dynamic business environment – In today’s global business environment
...
A project manager’s office or PMO is the focus of
...
and are acquired with time depending on the roles
...
manager’s oral and written communication skills are
...
would insure that the important projects don’t have
...
accompanied by the approximate cost to be borne
...
Case study: CIO Dennis L’Heureux uses PMO
for Rockford Health
...
Like many other CIOs facing similar situations
today, Dennis L’Heureux’s IT firm is being burdened with more projects than it can actually execute. L’Heureux, says that they are unable to meet
the ever growing demand. He has been serving as the
Rockford Health System CIO for the last 14 years. He
maintains that business managers have to be consistently told that their demand surpasses the company’s

41

capacity to deliver.
To structure and organize the various projects
being handled by Rockford Health, a project management office was created by L’Heureux sometime
back. It is the job of the PMO officer to suggest which
employee should be put to work on which project,
forming different project teams. L’Heureux on the
...
According to L’Heureux, his role as CIO in project
...
bask in glory.
From L’Heureux’s experience, we understand how
it is the responsibility of the CIOs of companies to

© Thinking Portfolio

establish discipline standards with regards to project
...
a communication plan. Involve your stakeholders in
...
Thinking Portfolio® – Easy to use, fast to implement
Thinking Portfolio is a simple, yet powerful, solution for those who want to move from
spreadsheets to a professional IT application portfolio management tool, but don’t want
to spend years on implementation. In addition to application portfolios, our SaaS based
platform is used for idea management, project and service portfolio management.
...
livery styles are largely determined by organizational
...
a good PMO’s abilities are judged based on his/her
...
difference in a project’s outcome.
45
...
problems arise, but can be used to foresee potential
...
As an IT project manager, it is imperative to communicate with your team as well as stakeholders
...
Ordinary project managers stay on the road.
...
Great project managers have excellent negotiating
...
individual’s skills in the correct manner at the right
...
employee’s daily deadline to complete the internal
development project.
...
solution. In today’s competitive business world, innovation is given importance as it can give your business a competitive advantage.
With cross functional development projects, you
can initiate a creative collaboration. These teams

© Thinking Portfolio

are equally useful for both special projects as well
...
today’s decision making process is less goal dominated and focuses on making the best choice with multiple perspectives.
...
nected to the marketing and sales departments of
your company. A detail-oriented, smart, motivated,
and enthusiastic person can best handle business development as they can effectively sell your company’s
products.
...
company’s growth, ensure that you understand the
...
to the customer’s needs and gives them something
original.
...
Overcoming obstacles, working through project conflicts, and appreciating each other’s contribution can
...
arguments and highlighting other’s mistakes.
...
Project management doesn’t end with handing out
...
gritty. Put the right people on the job and don’t second guess them.
...
timeliness. Remember, collaborative software can’t
do your job for you. A good project manager doesn’t
substitute tools for human interaction. Use it as a
complementary tool.

A great project manager doesn’t just need good
...
Set systems in place, don’t be afraid to use
tools
...
out responsibilities from the start and don’t leave
...
the chain. Play on people’s strengths and give them
...
who doesn’t have the respect of his team. Being able
...
requires firm, decisive action. Don’t sit back and wait
...
preventing your project’s progress. Discuss the possible risks and barriers to the project with the client
...
experience is that the IT management’s view of PPM
...
and strategy-related criteria in their project portfolio. They can, for example, try to evaluate how projects contribute to achieving the company’s strategic
...
project can impact the project manager’s reputation
...
PMO can standardize the methodologies and process that make the project manager’s job a lot simpler, but no less significant. Standardized processes imply consistent performance and also make IT
...
tain risk factor, as well as estimating the likelihood
...
improves the ability of a business to be agile and of
...
risks take into consideration complexities of organizations, systems and external environments. Strategic risks need greater focus on management of opportunities and don’t respond to tools of probability.
...
strategic financial decisions at the right time. At
...
ject’s riskiness. Such categories can provide vital structuring of data for communication and
...
severity of impact and risk likelihood are each composed of six qualitative ratings. Basically, this approach has shown its potential and gained merits in
...
part. Then again, it isn’t as easy as it sounds, as many
businesses cant seem to quite master PPM. Here’s a
...
these practices right off the bat. Let’s take the example of a mature business versus a start-up; the former
has consistent evaluation protocols to measure how
various projects are impacting the business, while the
latter has to still set up ways to obtain this information whether it’s resource estimates or ROI, let alone
...
spell disaster for organization’s reputation. Companies can follow a proactive approach to security issues by installing firewalls and restricted entry into
...
3. Allowing only authorized personnel – Industrial espionage is a real threat in today’s cut-throat
...
then they may try to slow down each other’s’ progress by unscrupulous means. This can be avoided if project management office allots realistic
...
becomes the PMO’s responsibility.

79

Today is also a good
...
a cut or squeeze the project portfolio can bear before the entity loses its power. The portfolio’s power
...
all IT decisions are in alignment with the overall
...
can categorize projects into four broad categories
...
It is not advisable to include only new and/or important initiatives in your company’s portfolio. Ensure that ongoing projects that are often sidetracked
