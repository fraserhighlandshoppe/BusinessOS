# Content from How to Write Blog Posts that Sell _ DigitalMarketer.md

## Topic: Social

# How to Write Blog Posts that Sell _ DigitalMarketer.html

```markdown
How to Write Blog Posts that Sell | DigitalMarketer
How to Write Blog Posts that Sell | DigitalMarketer
Get Started
...
Want to be a content marketing master? Get our step-by-step plan for turning content into free, organic traffic and get certified as a Content Marketing Specialist!
March 2, 2017
By
Russ Henneberry
Share1K Tweet2K Share254Shares 4K
Do your blog posts pack the necessary punch that will turn readers into customers?
According to WordPress, 75.7 million new posts are published every month.
...
(NOTE: Want to be a content marketing master? Get our step-by-step plan for turning content into free, organic traffic and get certified as a Content Marketing Specialist!)
...
Then, open the ADVANCED FILTERS and INCLUDE only the EVENT ACTIONS you want to include. For example, if I want to measure how many clicks I received to the “Ultimate Facebook Ad Template Library” landing page located at https://www.digitalmarketer.com/lp/fb-ad-templates/ I would use this filter…
If you want to include multiple pages as calls to action in your reporting, you’ll just place a “pipe” (they look like this: |) between each page extension. For example, if I want to add clicks to this page >> https://www.digitalmarketer.com/lp/ultimate-social-media-swipe-file to my reporting along with clicks to this page >> https://www.digitalmarketer.com/lp/fb-ad-templates/ I would put this in my advanced filter…
...
Next Post
[Download] The 8-Step Email Deliverability Checklist to Generate More Conversions, Revenue, and Customer Engagement
Search the Blog
