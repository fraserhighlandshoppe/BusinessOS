# Content from Step 7 Make the Offer CTA #1—Gain.md

## Topic: Social

# Step 7 Make the Offer CTA #1—Gain.html
...
NOTE: Shorter, explainer-style sales videos will end here. If you want to create a VSL that's 2 minutes or less, you'll give 1 CTA, then you're done. Like we do here with our Chocolate Cake Diet example:
"So if you're fed up with being fat, and you just want to eat chocolate cake all day, then get a copy of my book, 'The Chocolate Cake Diet' today by clicking on the link, below..." From here, the video would close.
