# Choosing Your Ad Tracking Type.html
...
Choosing Your Ad Tracking Type
The key to running successful online advertising campaigns is to create split tests, measure your results and optimize as needed.
To measure your ad campaigns, you need to measure clicks, conversions and cost. Many campaign tracking tools only measure clicks.
For example, on my Wordpress website I use Pretty Link to create my own tracking links. Pretty Link is great for creating custom tracking URL’s  but it only tells me how many times someone clicks on my link.
To accurately measure the performance of your online ad campaigns you need to track clicks and conversions. You need a tool that lets you create URL tracking links and provides a pixel you insert on the thank you page of your campaign.
When someone clicks on your tracking URL, the click is registered and the pixel will trigger a conversion only when they land on your thank you page after completing your desired action. If they click on the tracking URL and don’t take your desired action, the pixel will not trigger a conversion.
LinkedIn
LinkedIn provides a lot of information about your campaign but they don’t track conversions which is unfortunate. Conversion tracking is in the works but there is no ETA.
LinkedIn shows you Impressions, Clicks, Average CTR, Total Social Actions (Likes, Comments, Shares), Total Engagement (paid clicks + social clicks), Average Engagement, Average CPC, Average CPM and your total ad spend. This data lets you know how engaging your content is but we’re still missing the most important stat, your total conversions.
Clickmeter
There are plenty of free and paid tools that will track your campaigns including conversions. One of these easy-to-use tools is Clickmeter which creates custom tracking URL’s and provides a conversion pixel for your thank you pages. The free account lets you track a limited number of campaigns and they have very affordable premium options which allow comprehensive tracking of your campaigns.
Google Analytics/URL Builder
This is probably the best way to track your LinkedIn campaigns because I assume you are already tracking your website activity with Google Analytics.
Use the Google URL builder to create your custom tracking links and use these links in your LinkedIn campaigns.
Refer to the How to Master Google Analytic Execution Plan to learn how to set up your Google Analytics Goals and UTM tracking URLs.
