...
Here’s an example of a campaign with a different goal. In this case, the clothing company ModCloth wanted to take people who were already engaged with their content...and get those people to subscribe to their email list.
The content needed for this campaign is pretty straightforward: it’s a blog post. When you go to the ModCloth blog, you’ll see many helpful blog articles like this one:
...
Well, you’ll notice that while you’re browsing the blog you will be greeted with this popup:
