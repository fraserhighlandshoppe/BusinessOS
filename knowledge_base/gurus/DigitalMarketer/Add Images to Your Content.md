# Add Images to Your Content.html
...
Add Images to Your Content
Text ads are boring and receive very little interaction. Have you noticed that your social media posts receive more interaction when you add images? People love pictures so add images to your LinkedIn ads to increase interaction.
You can use a tool like Canva to build great images for your ads.
Self-Service Ads
Add a 50x50 image to your self-service ads. Depending on your offer, you can add headshot images, your logo is an image of your tripwire offer. This image should match images on your landing page.
Here some self-service ads with less-than-desirable images. The top ad image is very dark and you have to look very closely to see what the image is. The next ad image is too small which makes it even harder to tell what they are promoting. The third ad didn’t bother to add an image at all, which makes their ad even less desirable.
Here’s a better example of images in self-service ads. The top and bottom ads have easy-to-see images which add value to the ad. Digital Board Papers is using their logo and the Master Social Marketing ad shows an image that could be someone performing social media marketing.
Sponsored Updates/Content Marketing images
This infographic in the Kaiser Permante ad increases engagement. This post/ad received 513 Likes and 30 Comments in one day.
The landing page is clean and simple. When you click on the landing page, the PDF guide downloads instantly with no opt in required.
