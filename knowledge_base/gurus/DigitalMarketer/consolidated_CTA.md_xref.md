...
|---|---|---|
| 1 | Source file: consolidated_CTA.md.md (line review needed) | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
