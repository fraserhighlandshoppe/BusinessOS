# XREF — Boomerang Traffic Plan__Google Tag Manager - The Ultimate Guide _ DigitalMarketer.md
# Source guru/file: Boomerang Traffic Plan__Google Tag Manager - The Ultimate Guide _ DigitalMarketer.md_xref.md
# Format: table (para by para ordered)
| Para | Source .md file line/context | Destination (HowTo/domain) | Notes |
|---|---|---|---|
| 1 | Line ~1 — # Google Tag Manager - The Ultimate Guide _ DigitalMarketer.html | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
| 4 | Line ~4 — Google Tag Manager - The Ultimate Guide \| DigitalMarketer | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
