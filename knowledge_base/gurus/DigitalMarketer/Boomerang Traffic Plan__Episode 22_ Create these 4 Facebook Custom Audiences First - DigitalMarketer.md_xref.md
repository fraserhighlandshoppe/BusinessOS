# XREF — Boomerang Traffic Plan__Episode 22_ Create these 4 Facebook Custom Audiences First - DigitalMarketer.md
# Source guru/file: Boomerang Traffic Plan__Episode 22_ Create these 4 Facebook Custom Audiences First - DigitalMarketer.md_xref.md
# Format: table (para by para ordered)
| Para | Source .md file line/context | Destination (HowTo/domain) | Notes |
|---|---|---|---|
| 1 | Line ~1 — # Episode 22_ Create these 4 Facebook Custom Audiences First - DigitalMarketer.html | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
| 4 | Line ~4 — Episode 22: Create these 4 Facebook Custom Audiences First - DigitalMarketer | MarketingHowTo.md (Section 2 - Traffic/Ads) | Auto-filled batch 8 |
