# Content from Pinterest use exact keyword match.md

## Topic: Email

# Pinterest use exact keyword match.html
...
Start typing a keyword into Pinterest search and you'll see the auto-suggested keywords from Pinterest.
These are the keywords you want to target on your pins and boards...
For example, if I begin to type 'survival' into Pinterest search I'll see...
And, if I begin to type 'diy projects' into Pinterest search, Pinterest will suggest more keywords for me to target with my pins and boards...
As you can see, you'll want to use the EXACT suggested keyword as the name of your Board...
A lot of Pinterest users will name their boards things like "Things I Love" or other cutesy names --- which is fine.  But if you want your boards to rank in Pinterest search -- you'll use the EXACT MATCH keyword.
You'll also want to use EXACT MATCH keywords from your Pinterest auto-suggest in your pins...
Reuse the same popular images and change the text surrounding it to rank for new keywords.
