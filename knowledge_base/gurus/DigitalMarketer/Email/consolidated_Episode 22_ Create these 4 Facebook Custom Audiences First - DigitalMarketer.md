# Content from Episode 22_ Create these 4 Facebook Custom Audiences First - DigitalMarketer.md

## Topic: Email

# Episode 22_ Create these 4 Facebook Custom Audiences First - DigitalMarketer.html
...
How to target people that haven’t taken your offer (and exclude those that have)
How to troubleshoot your Facebook pixel set up using a free Google Chrome plug-in.
LINKS AND RESOURCES MENTIONED IN THIS EPISODE:
Facebook Power Editor –  Use the Facebook Power Editor to access additional Facebook ad features.
FB Pixel Helper – Use this Google Chrome plug-in to troubleshoot your Facebook ad pixels.
