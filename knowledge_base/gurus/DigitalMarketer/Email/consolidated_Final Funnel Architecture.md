# Content from Final Funnel Architecture.md

## Topic: Email

# Final Funnel Architecture.html
...
Final Funnel Architecture
Now, all you have to do is run through all your research findings on all the worksheets you filled out and pull it all together in your Final Funnel Architecture Worksheet. When that is complete, you can use a tool like Optimize Press, Lead Pages, Instapage or Click Funnels to actually build out the data-driven funnel that you designed using this process.
Also, use the information that you discovered about your target audience to more specifically target your ads as you start to buy paid media on Facebook, Google Search, Google Display Network, Twitter, Pinterest and LinkedIn.
Use your Ad Network research to purchase ads on various ad networks, and us the information you found out about incoming and exiting traffic to go directly to specific sites and purchase ad space.
You are now the proud owner of a data-driven funnel and data-driven ad campaign.
Good luck!
