# Content from Using Amazon Best-Seller's List to Shape Your Funnel.md

## Topic: Sales

# Using Amazon Best-Seller's List to Shape Your Funnel.html
...
That information is very helpful because it’s based on what people are actually searching for. The only thing better than that would be to base your funnel on what people are actually BUYING.
That’s what we’re going to do in this step. We’ll take a look at Amazon’s best-selling books and other products to get ideas about what people are already purchasing and then use that information to further refine our ideas about the 5 Things in our funnel.
Let’s start by going to Amazon and checking out the best-selling books in our category. Here’s how to do it:
The numbers in the red circles will help to guide you through the process of research on Amazon. Number 1 shows that we’ve selected to look in the category of Books only. Number 2 is where we type in our keyword, in the case of this example, “memory improvement.”
Click “Best Sellers” as shown by number 3, and drill down to your category as shown in number 4, where we’ve selected “Self-Help” and then further refined the category to “Memory Improvement” as shown by number 5. Run through this process for your primary keyword to find the most drilled down category you can.
The results of our search are then shown in items 6, 7, 8 and 9 as the 4 best-selling books on Amazon in the Memory Improvement category. The duplicates are because 2 of the books are best-sellers in both hardcover and paperback format.
Note the “Look Inside” text on all of these books. Most, but not all, of the books you’ll find as best-sellers have the “Look Inside” feature, which allows you to see parts of the book, hopefully the front and back covers and tables of contents.
Let’s click on number 6, “Moonwalking With Einstein” and then click again on the Look Inside image on the left. You should see an image similar to the one below now:
The first thing to look for is anything that might be useful for any of the 5 Things in the 5 Things Funnel or copy to ads or sales and marketing materials. Because the book’s subtitle describes a strong benefit in a powerful way, let’s write that down. “The art and science of remembering everything.” Sounds great!
Now, let’s look at some other parts of this book.
Unfortunately, this Look Inside doesn’t allow us to see the back cover. The back cover usually contains highly useful copy, including benefits and features that can help you create killer sales copy and even get new idea for parts of your funnel. In this case, neither the paperback nor the hardback version provided a back cover.
Not one to shy away from a challenge, I quickly Googled “Moonwalking With Einstein Back Cover” and after clicking several images of the book for about 5 minutes, I found a version on Amazon with a “Flip To Back” option as shown in the image below:
I clicked the image, and voila, there was the back as shown below:
Because most people do, in fact, judge a book by its cover, we know that the primary selling factor for any book is its cover, the title and the supporting text on the front and back. In this case, we’ve got a lot of great copy we can grab and save for later, including:
US Memory Championship, “even an average memory… could win the event,” “ancient techniques once employed by Cicero,” “medieval scholars [who could] memorize entire books,” “cutting-edge research” and last but not least, “venerable tricks of the mentalist trade.” See how this can give a ton of great copy ideas?
Number 10 in the image with all the red circles shows what’s hot and can give you ideas about trending topics, and item 13 shows the items most wished for, which can be a good indication of what people want as well.
Go through the best-sellers in your category and make notes on the Best-Selling Books Worksheet.
