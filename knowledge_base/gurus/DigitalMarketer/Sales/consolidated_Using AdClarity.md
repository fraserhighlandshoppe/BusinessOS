# Content from Using AdClarity.md

## Topic: Sales

# Using AdClarity.html
...
Using AdClarity
AdClarity works pretty much like AdBeat. If you’d like to give it a try, just follow the steps similar to those outlined in the section on AdBeat.
