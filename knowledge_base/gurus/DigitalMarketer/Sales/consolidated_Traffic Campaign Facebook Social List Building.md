# Content from Traffic Campaign Facebook Social List Building.md

## Topic: Sales

# Traffic Campaign Facebook Social List Building.html
...
Community
Getting Started
How to Get Your First 1,000 Blog Subscribers and More
Previous Step
Next Step
1. Start Here
...
In this article, I break down for you how to scale your Facebook campaigns by targeting audiences similar to those that have already converted. Audience Insights is a revolutionary tool for scaling your Facebook campaigns! Find the original article here, and join the conversation in the comments.
