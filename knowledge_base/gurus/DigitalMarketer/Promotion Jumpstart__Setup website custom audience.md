# Setup website custom audience.html
...
Getting Started
×
First time visitor? Then start here and learn more about Digital Marketer!
The Content Booster Jumpstart Pack
Previous Step
Next Step
1. Start Here
...
5. Content & Paid Traffic
Content & Paid Traffic
6. Cold Traffic & Offers
Setting Up Your Cold Traffic Campaign
7. Warm Traffic Content & Offers
Setting Up Your Warm Traffic Campaign
8. Hot Traffic Content & Offers
Setting Up Your Hot Traffic Campaign
9. Troubleshooting Your Campaign
Troubleshooting Your Campaign
10. Case Study: The Dipsy Doodle
The Dipsy Doodle
11. Downloads/Resources
Downloads/Resources
12. Give Us your Feedback
...
Log in to Facebook Business Manager and click the “audiences” tab, as shown below:
Find the “Create Audience” button and click “Custom Audience.”
You will be prompted to choose the type of audience you want to create. Choose “Website Traffic.“
You’ll then accept Facebook’s Terms of Service and click Create Audience.
Now, it’s time to set up your WCA. We’ll start with the first “category” from our excel document.
Blogging.
Click the “Custom Combination” button:
Remember, you want to include the URLS (the part of the URL past the root domain… e.g. www.digitalmarketer.com/6-million = /6-million) of any article that we have on the website that doesn’t have “blogging” in the URL, but that we want to include in this audience.
We also want to include the keyword “blogging” because that’s what we have decided to use moving forward. Every blog post that is published on our blog in the future (about blogging) will have this keyword in the URL so that visitors will automatically be added to this audience.
Website Traffic: When setting up categories to segment your audience, check “Custom Combination.“ We’ll get into the other options later.
Include (URL CONTAINS): As you can see, we added all of the URLs (the text after the .com—the root domain) of old content from our excel sheet in the category of blogging. We also added the keyword “blogging” (highlighted in blue) to ensure every page we create from here on out that has to do with blogging will be added to this WCA—as long as we include the word ‘blogging’ in the URL. Dynamic, baby!! You’ll never have to come back and edit this audience again.
Number of Visits: Keep this at 1 to start.
In the last: The default is 30 days. Facebook will let you go up to 180 days. we usually maximize the length at 180 days so that we can keep people in our audience for as long as possible.
...
Visited website on: Select “ALL” so that you can capture as much of the audience as possible.
Audience Name: Name the audience something that you can remember. We name them the category of the content.
After you submit the custom audience, it will display under the audience tab.
...
Don’t worry if your audience doesn’t start to populate, it may take time. Also, if you don’t have traffic to your site yet, that’s ok! You have these set up to maximize traffic once it comes.
We used this same process to enter all of the categories from our excel file.
This way, We’re segmenting our Facebook custom audiences into specific topics. If you don’t have a way to segment an audience, go ahead and set up a WCA for everyone who hits your site at all—why not?
Follow the steps above but simply select “Anyone Who Visits Your Website” instead of “Custom Combination.”
...
$295/month
Try Lab Elite FREE for 17 Days
$2995/year
Try Lab Elite FREE for 17 Days
Lab ELITE TEAM
