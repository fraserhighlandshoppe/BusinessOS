...
In the example below, he simply asks them to add his address to their contacts or email address book.
This could be taken a step further and link out to specific steps to make sure they get the correct steps completed.
