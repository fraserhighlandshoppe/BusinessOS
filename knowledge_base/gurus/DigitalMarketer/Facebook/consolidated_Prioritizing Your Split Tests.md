# Content from Prioritizing Your Split Tests.md

## Topic: Facebook

# Prioritizing Your Split Tests.html
...
Prioritizing Your Split Tests
For every test you run, there are an infinite amount of other possible tests you could run. As a result, every test has an opportunity cost. It’s because of this opportunity cost that you must qualify and prioritize your tests.
Prioritizing tests is actually really easy. In fact you can prioritize your tests based on the four qualification criteria laid out in the last section.
The best way to do this is to assign a numerical score for each criteria (I use a ranking of 1 - 5). The tests with the highest overall score takes priority.
Here’s an example of how I prioritize my tests. This excel doc is also available below.
Resources:
Test Priority Excel Document
