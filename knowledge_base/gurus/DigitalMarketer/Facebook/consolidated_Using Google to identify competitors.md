# Content from Using Google to identify competitors.md

## Topic: Facebook

# Using Google to identify competitors.html
...
Using Google to Identify Your Top Organic Search and Paid Competitors
Open Google in your web browser. Now, type in what you think your primary keyword is. In my case, I’m going to do a memory improvement product, so I will type in “memory improvement” in the search box.
Now, take a look at the top 10 results in the organic section of the search engine results pages (SERPs). The 10 websites that appear on page 1 of those results are your biggest organic search competitors. Write down their websites on the Organic Search Competitors Worksheet.
Next, look at the sponsored ads that appear above and to the right of the organic search results. These are advertisements that people are paying to have appear whenever someone searches for the keywords that you just typed in to get these results.
These paid search results can be useful later as we do more in-depth research, and they can help ferret out successful competitors that don’t show up in the organic search results. So, write down the top 10 paid search competitors on the Paid Search Competitors Worksheet.
(Note: Depending on your keyword(s), it’s possible that no paid search competitors will appear. If no one is paying to advertise to people searching for the keyword(s) you typed in, that’s a pretty good indication that your initial keywords are not commercial. After all, if one of your competitors could make money advertising to people searching for those keywords, there would be paid search ads in the results!
It is also possible that you will only see 1 or a few paid search ads in the SERPs for your keywords. If so, write those down, and you can also check on page 2, 3 and 4 of the SERPs to identify up to 10 paid search competitors.)
