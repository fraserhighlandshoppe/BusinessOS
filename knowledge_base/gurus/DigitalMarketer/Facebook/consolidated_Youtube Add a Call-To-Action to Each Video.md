# Content from Youtube Add a Call-To-Action to Each Video.md

## Topic: Facebook

# Youtube Add a Call-To-Action to Each Video.html
...
When you upload the video to YouTube, you will use the YouTube Cards function to add the actual CTA button into the video.
But, when you are shooting the close to your video, you will want to point in the direction of the call-to-action button --- that won't be there until later when you upload the video.
Here's an example... when I shot this video --- the CTA button wasn't there --- it was added in after we uploaded to YouTube.
Watch this video and the way it closes with a call-to-action...
And watch how Rock Ullah does this in a "Charm" video for his Basketball Training company...
Both Rock and I were pointing at thin air when the video was shot and the call-to-action was added after it was uploaded to YouTube.
The key to this is to use the call-to-action to drive clicks from YouTube to a relevant Lead Magnet.
You can learn how to create a Lead Magnet, in this Execution Plan or read this blog post.
