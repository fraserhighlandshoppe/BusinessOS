# Promote Your Lead Generation Card.html
...
Tweet it to your following using the Compose Tweet with this card option or by copying the link to your card and adding it to a tweet.
