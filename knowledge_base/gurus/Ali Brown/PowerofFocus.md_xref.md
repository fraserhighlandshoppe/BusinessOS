# XREF — PowerofFocus_xref
# Source: PowerofFocus.md.md
...
|---|---|---|
| 1 | Source file: PowerofFocus.md.md (line review needed) | MarketingHowTo.md / SalesHowTo.md / OperationsHowTo.md (relevant section) |
