---
title: "Mistakes that kill a startup"
source: "http://fhsws002.ksfraser.com/infra/wiki/index.php?title=Mistakes_that_kill_a_startup"
type: wiki
categories: Marketing
author: Fraser Highland Shoppe Wiki
---

Original Source http://www.paulgraham.com/startupmistakes.html  This was written for Programmers, but the concepts are universal.


In a sense there's just one mistake that kills startups: not making something users want. If you make something users want, you'll probably be fine, whatever else you do or don't do. And if you don't make something users want, then you're dead, whatever else you do or don't do. So really this is a list of things that cause startups not to make something users want. Nearly all failure funnels through that.
...
In practice what happens is that the business guys choose people they think are good employees but who aren't. Then they're mystified to find that their startup lumbers along like a World War II bomber while their competitors scream past like jet fighters. This kind of startup is in the same position as a big company, but without the advantages.

So how do you pick good employees? I don't think there's an answer. You will have to do frequent performance measurements and reviews to ensure the employees are producing results benfitting the company.

==8. Slowness in Launching==

Companies of all sizes have a hard time getting something done. It's intrinsic; things are always 85% done. It takes an effort of will to push through this and get something released to users. [3]

Startups make all kinds of excuses for delaying their launch. Most are equivalent to the ones people use for procrastinating in everyday life. There's something that needs to happen first. Maybe. 
...
Think about the overall goal, then start by working on the smallest subset of it that does anything useful. If it's a subset, you'll have to implement it anyway, so in the worst case you won't be wasting your time. But more likely you'll find that implementing a working subset is both good for morale and helps you see more clearly what the rest should do.
...
[[Category: Startup]][[Category: Running the business]][[Category: Marketing]]