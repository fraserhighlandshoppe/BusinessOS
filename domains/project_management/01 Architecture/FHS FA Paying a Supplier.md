...
## Overview
Process for paying suppliers in FrontAccounting.

## Payment Timing Options
FrontAccounting allows payment:
...
- Go to **Purchase** tab
- Select **Payment to Suppliers**

### Step 2: Enter Payment Details
**Supplier Payment Entry**:
1. Select the correct vendor
2. Select the correct date payment was made
3. Select the bank account payment was made from
4. Enter bank charge if applicable
5. Select invoices to send payment for
6. Enter allocation amounts
7. Enter memo
8. Hit **Process**

### Step 3: Generate Remittance
On the next screen:
