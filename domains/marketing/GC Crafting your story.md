...
- What messages do I have to tell?
- How do I build this message out?

## Model, Mimic, Master
**Problem**: You don't discover who you are.
...
## Mind Map Categories
- **Family**: Son, Dad and Mom, Brother, Husband, Step father
- **Professional**: Sales, Student, Coach, Teacher, Trains
- **Technical**: Computer Programmer, Real Estate investments, Stock Market investors
- **Skills**: Pipe Major, Chess, Rifle shooting, World traveller, Reader
- **Extended Family**: Uncle
- **Passions**: Bagpipes
- **Challenges**: Diabetic, Overweight

## The Story Process

### What are the stories around the mind map?

## Key Insights

### Connection Breeds Trust
When people feel they connect with someone authentically:
- They become more confident in that person
