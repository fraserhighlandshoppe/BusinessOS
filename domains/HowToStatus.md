---
# Phase 4 Master Guides Status
# Master guide for merging domain files per domain with bibliography

Tags: #howto #masterguide #phase4
---

# Phase 4: Master Guides (Status as of this session)

| Domain | Status | File | Key sections |
|---|---|---|---|
| marketing | ✅ LIVE (f52319d) | MarketingHowTo.md | 8 sections, 8 source refs |
| sales | ✅ LIVE (8c01f6c) | SalesHowTo.md | 7 sections, 12 source refs |
| business | ✅ LIVE (b590fcd) | BusinessHowTo.md | 6 sections, bibliography |
| email | ✅ LIVE (ee10e30) | EmailHowTo.md | 6 sections, bibliography |
| social_media | ✅ LIVE (new) | SocialMediaHowTo.md | 5 sections, bibliography |
| web | ✅ LIVE (new) | WebConversionHowTo.md | 3 sections, bibliography |
...
- swipe/salesletter_formulas.md: Hero's Journey + 15-step skeleton ✅
- swipe/swipe_verb.txt (32) / noun.txt (97) / adjective.txt (38) / number.txt (30) / audience.txt (19) / headlines_raw.txt / candidates_by_frequency.txt ✅
- Verification: partial (formulas mapped, variables counted; 8234 mined lines contain non-headline narrative — needs headline-only filter)

# Phase 3 Audit (current status)
- Audited: all domain .md files; master guides have tags/references; most domain source files (sales/*.md, marketing/*.md, business/*.md, email/*.md, mindset/*.md, trading/*.md, social_media/*.md, web/*.md) have 0 tags, 0 refs, 0 guru hashtags.
